 ...
 *
 * Purpose: initialise LEDC PWM on GPIO 1 for the passive event buzzer.
 *
 * Configures timer 1 at 2 kHz, 13-bit resolution (8192 steps), binds
 * channel 1 to GPIO 1, starts silent (duty 0), and emits the power-on
 * beep.
 *
 * The buzzer sits between 3.3 V and GPIO 1 (GPIO sinks to sound it), so
